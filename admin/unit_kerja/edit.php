...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    // Query untuk mengambil data unit_kerja berdasarkan id
...
if (isset($_POST['submit'])) {
    ...
    $_nama = $_POST['nama'];
    $data = [$_id, $_nama, $id];
    // Query SQL untuk update data unit_kerja berdasarkan id
    $sql = "UPDATE unit_kerja SET id = ?, nama = ? WHERE id = ?";
    $stmt = $dbh->prepare($sql);
    $stmt->execute($data);
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h2 class="text-center">Form Unit</h2>
